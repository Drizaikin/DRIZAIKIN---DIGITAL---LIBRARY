  ...
  return (
    <footer 
      ...
      style={{ 
        ...
        borderTop: `1px solid ${darkTheme.colors.logoAccent}30`,
      }}
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div 
            ...
            style={{ 
              background: `linear-gradient(to right, ${darkTheme.colors.accent}20, ${darkTheme.colors.accent}10)`,
              border: `1px solid ${darkTheme.colors.accent}30`,
            }}
          >
            <Sparkles size={16} style={{ color: darkTheme.colors.accent }} />
            <span 
        ...
        >
          <p 
            ...
            style={{ color: darkTheme.colors.mutedText }}
          >
            <BookOpen size={12} style={{ color: `${darkTheme.colors.accent}50` }} />
